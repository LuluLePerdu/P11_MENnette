...
///@brief Fichier source pour la classe ConfigurationWidget. Permet de configurer les paramètres de jeu pour les différents jeux et la création de l'interface utilisateur. - Fichier fait à la main pour l'évaluation de l'APP7
